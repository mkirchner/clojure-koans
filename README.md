# Solutions to the Clojure Koans

These are my solutions to the [clojure koans](https://github.com/functional-koans/clojure-koans).
Please clone the original repo located 
[here](https://github.com/functional-koans/clojure-koans).
